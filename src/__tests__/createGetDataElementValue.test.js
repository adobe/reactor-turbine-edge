...
// const d = 'function returned by createGetDataElementValue';
// let createGetDataElementValue = require('../createGetDataElementValue');

// const createGetDataElementDefinition = (settings) => {
//   const getDataElementDefinition = sinon.stub();
//   getDataElementDefinition.withArgs('testDataElement').returns(settings);

//   return getDataElementDefinition;
// };
...
// const replaceTokens = sinon.fake((_, settings) => settings);

// test.beforeEach(() => {});

// test(`${d} returns a data element value using data from settings`, (t) => {
...
// test(`${d} returns a data element value using data from event`, (t) => {
//   const getDataElementDefinition = createGetDataElementDefinition({
//     settings: {}
//   });

//   const getDataElementValue = createGetDataElementValue(
//     createModuleProvider((_, event) => event.foo),
//     getDataElementDefinition,
//     replaceTokens
//   ).bind(null, null);
...
//   t.is(getDataElementValue('testDataElement', event), 'bar');
// });
